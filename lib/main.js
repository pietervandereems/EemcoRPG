...
module.exports = function () {
    "use strict";
    var db = new (require("lib/db"))(),  // Libraries
...
// EVENTS
    ...
    event.on("typeLoaded", function (type) {
        if (type) {
            db.getView("rpg", "listByPlayer", {startkey: [type], endkey: [type, {}], reduce: false, include_docs: true}, function (err, result) {
                var i,
                    ev;
                if (!err) {
...
// Temp? Get show for player
    db.getShow("rpg", "player", "d1ff13bf9ce957c955e46b228f0003b2", function (err, result) {
        var player;
        if (!err) {
...
// Retrieve Information
    db.getView("rpg", "listTypes", {key: ["player", "Pieter van der Eems"], reduce: false}, function (err, result) {
        if (!err) {
